...
public class ListConcepts {
	...
	public void listconceptimplementation(String actualcountryname,String actualcityname) throws InterruptedException
	{
		...
		/// City selection
				...
				List<WebElement> allelementcity=driver.findElements(By.xpath("//*[@id='j_idt87:city_items']//following-sibling::li"));
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ListConcepts c = new ListConcepts();
		c.listconceptimplementation("India", "Chennai");
	}
